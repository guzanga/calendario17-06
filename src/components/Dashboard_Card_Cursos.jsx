        ...
        <div>
            <div className={css.card_profs}>
                        ...
                        <div className={css.campo2} key={index}>
                            ...
                            {expandedIndex === index && (
                                <>
                                    ...
                                    <p className={css.professores}>Data de Início: {curso.data_de_inicio}</p>
                ...
                <div className={css.plus}>
                    ...
                    >
                        <div className="modal-content">
                            <select onClick={(e) => setIdProfessor(e.target.value)}>
                            ...
                            <select onClick={(e) => setIdSala(e.target.value)}>
                                {salas.map(sala => (
